"""Config flow for DE BLE Blood Pressure Monitor integration."""
...
class DEBleBloodPressureMonitorConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for DE BLE Blood Pressure Monitor."""
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            ...
            return self.async_create_entry(
                title=discovery_info.name or "Blood Pressure Monitor",
                data={
        ...
        for discovery_info in async_discovered_service_info(self.hass):
            if discovery_info.address in current_addresses:
                continue
            if BP_SERVICE_UUID in discovery_info.service_uuids:
