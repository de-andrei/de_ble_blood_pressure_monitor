"""Binary sensor platform for DE BLE Blood Pressure Monitor."""
...
class MeasurementCompleteSensor(BinarySensorEntity):
    """Representation of measurement complete status."""
    ...
    def is_on(self) -> bool | None:
        ...
        return self.coordinator.measurement_complete
